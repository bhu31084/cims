...
function showCal(name, title, field, form) {
 ...
 //addCalendar("Calendar2", "Select Date", "secondinput", "sampleform");
  ...
  if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
    ...
    if (!hasCal) {
      if (isIE || isOpera6) {
        calWin=window.open("","cal","toolbar=0,width="+calWidth+",height="+calHeight+",left=200,top=200");
