...
<script >
	...
	function showTeamPlayers(){		
		...
		document.frmplayerStatus.action="TeamLineUp.jsp";
       	document.frmplayerStatus.submit();		
	}

	function showWagonWheel(matchid){		
		//alert("matchid "+matchid);
		window.open("wagonwheel.jsp?matchid="+matchid,"CIMSwagonwheel",'location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,top=400,left=100,width=600,height=500');		
	}
	function Showinningsummery(matchid){
		//alert(matchid)
		window.open('InningsDetail.jsp?matchid='+matchId,'inningdetail','top= 50,left = 50,location=no,directories=no,status=yes,menubar=no,scrollbars=no,resizable=no,width=420,height=400');
	}
	function ShowLiveScoreCard(matchid){
		//alert("matchid "+matchid)
		window.open("liveScoreCard.jsp?matchid="+matchid,"CIMSweb",'location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,top=310,left=780,width=200,height=252');
	}	
