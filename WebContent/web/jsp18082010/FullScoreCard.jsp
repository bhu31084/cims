...
function changeImageSrc(id, type){
	...
	function displayWagon(id, type){
		document.getElementById("responseWagon").src = "ResponseWagonWheel.jsp?id="+id+"&type="+type;
		document.getElementById('WagonWheel').style.display = "";
	}
	
	function displayPitchPad(id, type){
		//alert(id + ' - ' + type)
		document.getElementById("responsepage").src = "ResopnseBallPitched.jsp?id="+id+"&type="+type;
...
function printreport(){
	...
	winhandle = window.open("battingbowlingdetails.jsp?matchId="+matchId+"&InningId="+InningId+"&flg=1","battingreport","location=no,directories=no,status=no,menubar=no,scrollbars=Yes,resizable=yes,top=0,left=0,width="+(window.screen.availWidth-40)+",height="+(window.screen.availHeight-20));
}
function Inning(id){
	...
	if (xmlHttp==null){
	  ...
	  var flg = "P";        
	   var url = "InningScorecard.jsp?InningIdPre="+InningId+"&flg="+flg;
...
function callRefresh(matchid){
	document.main.action="FullScoreCard.jsp?matchid="+matchid;
