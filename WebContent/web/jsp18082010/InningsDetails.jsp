...
function printreport(){
	...
	winhandle = window.open("battingbowlingdetails.jsp?matchId="+matchId+"&InningId="+InningId+"&printFlg=1","battingreport","location=no,directories=no,status=no,menubar=no,scrollbars=Yes,resizable=yes,top=0,left=0,width="+(window.screen.availWidth-40)+",height="+(window.screen.availHeight-20));
}
function Inning(id){
...
function callRefresh(){
	document.main.action="InningsDetails.jsp"
