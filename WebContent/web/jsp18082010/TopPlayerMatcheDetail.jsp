			...
			var username = document.getElementById("hduserName").value 
				  ...
				  xmlHttp = this.GetXmlHttpObject();
		     	  if (xmlHttp == null) {
		          	...
		          	if(flag == "1"){
				       var url = "BtsStatisticsAllMatches.jsp?pid="+userid+"&seriesId="+seriesid+"&userName="+username+"&seasonId="+seasonid+"&flag="+flag
				    }else if(flag == "2"){
				       var url = "BowlStatisticsAllMatches.jsp?pid="+userid+"&seriesId="+seriesid+"&userName="+username+"&seasonId="+seasonid+"&flag="+flag
				    } 
