								    	...
								    	<td align="left">
								          ...
								          if(colorcount % 2 == 0 ){%>
							        		...
							        		<%}%>
								             ...
								             </td><td style="text-align: left;padding-right:10px;font-size: 11px;" valign="middle"><a style="text-decoration: none;color: black;" href="javascript:ShowSeriesPositionDetailDiv('<%=gsclubId%>','<%=seriestypeid%>','<%=season%>')" >
