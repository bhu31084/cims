	...
	function getMonthData(month){				
		...
		if(xmlHttp==null){
			...
			return;
				...
				var url;
		    	url="getMonthWiseResponse.jsp?month="+month+"&currentYear="+currentYear+"&monthFlag="+monthFlag;
		...
		function validate() {
			...
			if(document.frmplayerStatus.seriesName.value == "" ){
				...
				document.frmplayerStatus.action = "playersStatus.jsp";
	 ...
	 function displaySeriesTypeData() {
		...
		function getSeriesTypeList() {
           ...
           if(valName!="" && valName.length >= 2) {
		        var url = "SeriesTypeListAjaxResponse.jsp?seriesName="+valName;
   	        ...
   	        if(seriesName == "") {
				document.getElementById('seasonList').innerHTML = "<font color='RED'>Please Enter Tournament Name First</font>";
		           ...
		           if(valName!="" && valName.length >= 1) {
				        var url = "SeasonListAjaxResponse.jsp?seasonName="+valName;
      ...
      function callBowlerDetails(bowlerId,bowlerName){      	
		...
		if (xmlHttp==null){
			...
			if(document.getElementById("ShowBowlerDetailsDiv"+bowlerId).style.display==''){
				...
				var url ;		    	
		    	url="BowlerStatusResponse.jsp?bowlerId="+bowlerId+"&seasonId="+seasonId+"&bowlerName="+bowlerName+"&series_id="+series_id+"&flag="+flag;;		    	
      ...
      //	alert("flag  *****     "+document.getElementById('allflag').value)
		...
		if (xmlHttp==null){
			...
			if(document.getElementById("ShowBatsmanDetailsDiv"+batsmanId).style.display==''){
				...
				var url ;		    	
		    	url="BatsmanStatusResponse.jsp?batsmanId="+batsmanId+"&seasonId="+seasonId+"&batsmanName="+batsmanName+"&series_id="+series_id+"&flag="+flag;		    	
		...
		try {	
			  xmlHttp = this.GetXmlHttpObject();
	     	  if (xmlHttp == null) {
	          	...
	          	if(flag == "1"){
			       var url = "TopPlayerRunDetail.jsp?matchId="+matchid+"&userId="+userid+"&flag="+flag
			    }else if(flag == "2"){
			       var url = "TopPlayerRunDetail.jsp?matchId="+matchid+"&userId="+userid+"&flag="+flag
			    } 
...
<form action="playersStatus.jsp" method="post" name="frmplayerStatus" id="frmplayerStatus" >
