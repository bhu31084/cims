...
<%--													   		<td align="center" ><b>Live </b></td>--%>
														...
														<tr style="color:red;font-size: 12"><b><%=message%></b></tr>
															...
															<td align="center" nowrap="nowrap" ><a href="#" onclick="ShowTeamPositionDetailDiv('<%=gsteamId%>','<%=crsObjFirstSerPt.getString("series")%>')"><%=crsObjFirstSerPt.getString("team_name")%></a></td>
