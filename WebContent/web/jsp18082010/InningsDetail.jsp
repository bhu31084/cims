...
<%--<label style="font-size: large;font-weight: bold;" ><%=(String) ininDetail.get(1)%>Vs.<%= (String) ininDetail.get(2)%></label>--%>
	...
	<%
			int count1 = 1;		
			while (count2 > count1) {
	%>     <INPUT type="submit" class="button1" id="button" name="button" value="<%=count1%>" />
	<%
				count1++;
			}
	%>
	 	...
	 	<tr>
	 		<td align="center">
				...
				<br>
				<table style="width: 80%;" align="center" border="1" title="Live Score"
		...
		<tr>
			<td align="center">
				...
				<table style="width: 80%;" align="center"  border="1" title="Live Score" cellspacing="1"
					cellpadding="1" >
	...
	<table style="width: 80%;" align="center">
		<tr>
			<td align="center"><INPUT type="button" class="button1" id="button" name="button" value="Refresh" onclick="callRefresh()"/></td>
		</tr>	
		<tr>
