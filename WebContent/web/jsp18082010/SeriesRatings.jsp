...
<div id="TabbedPanels2" class="VTabbedPanels" align="left" >
  <ul class="TabbedPanelsTabGroup" style="font-size: 11px;">   
	...
	<li class="TabbedPanelsTab" id="seriestab"><a href="#" style="color: brown;" onclick="showpoints('<%=crsObjGetSeriesdata.getString("type")%>','<%=SeriesDescription%>')"><%=SeriesDescription%></a> </li>
