			...
			var username = document.getElementById("hduserName").value 
				  ...
				  xmlHttp = this.GetXmlHttpObject();
		     	  if (xmlHttp == null) {
		          	...
		          	if(flag == "1"){
				       var url = "/cims/web/jsp/BtsStatisticsAllMatches.jsp?pid="+userid+"&seriesId="+seriesid+"&userName="+username+"&seasonId="+seasonid+"&flag="+flag
				    }else if(flag == "2"){
				       var url = "/cims/web/jsp/BowlStatisticsAllMatches.jsp?pid="+userid+"&seriesId="+seriesid+"&userName="+username+"&seasonId="+seasonid+"&flag="+flag
				    } 
