...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=01&currentYear=<%=currentYear%>&monthFlag=<%=monthFlag%>',
	   cacheData: true,
       active: true	
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=01&currentYear=<%=currentYear%>&monthFlag=<%=monthFlag%>'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=02&currentYear=<%=currentYear%>&monthFlag=<%=monthFlag%>',
	   cacheData: true,
       active: true	
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=02&currentYear=<%=currentYear%>&monthFlag=<%=monthFlag%>'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=03&currentYear=<%=currentYear%>&monthFlag=1',
	   cacheData: true,
       active: true	
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=03&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=04&currentYear=<%=currentYear%>&monthFlag=1',
	   cacheData: true,
       active: true
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=04&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=05&currentYear=<%=currentYear%>&monthFlag=1',
	   cacheData: true,
       active: true
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=05&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=06&currentYear=<%=currentYear%>&monthFlag=1',
	   cacheData: true,
       active: true	
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=06&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=07&currentYear=<%=currentYear%>&monthFlag=1',
	   cacheData: true,
       active: true	
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=07&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=08&currentYear=<%=currentYear%>&monthFlag=1',
	   cacheData: true,
       active: true
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=08&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=09&currentYear=<%=currentYear%>&monthFlag=1',
	   cacheData: true,
       active: true	
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=09&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=10&currentYear=<%=currentYear%>&monthFlag=1',
	   cacheData: true,
       active: true	
<%	 }else{
%>	   dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=10&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	  	 dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=11&currentYear=<%=currentYear%>&monthFlag=1',
		 cacheData: true,
       	active: true
<%	 	}else{
%>	  	  dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=11&currentYear=<%=currentYear%>&monthFlag=1'
...
%>	  	 dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=12&currentYear=<%=currentYear%>&monthFlag=1',
		 cacheData: true,
       	active: true
<%	 	}else{
%>	  	  dataSrc: '/cims/web/jsp/getMonthWiseResponse.jsp?month=12&currentYear=<%=currentYear%>&monthFlag=1'
