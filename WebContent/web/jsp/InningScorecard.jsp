...
<%--			<br>--%>
<%--			<tr>--%>
<%--				<td align="center" valign="middle"><font color="red"><b><img src="../Image/wait24trans.gif" /></b></font></td>--%>
<%--			</tr>--%>
<%--		</table>--%>
<%--		</div>--%>
...
<table width="100%">
	<tr bgcolor="#f0f7fd">
		<td style="font-weight: bold;font-size: 16px;width: 65%;padding-left: 10px;" colspan="25"  nowrap="nowrap" align="left" ><%=teamOne.equalsIgnoreCase("") ? "-" :teamOne%> VS <%=teamTwo.equalsIgnoreCase("") ? "-" :teamTwo%> ,
		<%=tournamentName.equalsIgnoreCase("") ? "-" :tournamentName%></td>
	<%--		<td colspan="25" align="center"><%=tournamentName.equalsIgnoreCase("") ? "-" :tournamentName%></td>		--%>
	
		<td style="width: 35%;padding-left: 10px;" colspan="25" align="left" ><%=date.equalsIgnoreCase("") ? "-" :date%></td>		
	</tr>
	<tr bgcolor="#e6f1fc" style="width:100%">		
		<td align="left" style="padding-left: 10px;" colspan="25">Toss Won By : <%=toss.equalsIgnoreCase("") ? "-" :toss%>  and  Elected To :<%=electedto.equalsIgnoreCase("") ? "-" :electedto%> ,
		at : <%=city.equalsIgnoreCase("") ? "-" :city%></td>
		<%	if(maxInningId.equals(inningId) && matchStatusFlag.equals("A")){
%>	<td class="labelname" align="left" style="padding-left: 10px;" nowrap="nowrap" width="1%" colspan="25">[POINT : <font color="blue"><%=point.equalsIgnoreCase("") ? "-" : point%></font>]
<%--	<td  class="labelname" align="left" style="padding-left: 10px;" nowrap="nowrap" width="1%" >--%>
	Remaining Overs : <font color="blue"><%=remainingOvrs%></font></td>
<%  }else{
%>	<td class="labelname" align="left" style="padding-left: 10px;" nowrap="nowrap" width="1%" colspan="25">[POINT : <font color="blue"><%=point.equalsIgnoreCase("") ? "-" : point%></font>]</td>
<%	}
%>	
	</tr>
	<tr bgcolor="#f0f7fd" >		
		<td align="left" style="font-size: 12px;font-weight: bold;padding-left: 10px;" colspan="25"> Result : 
		<%	if( matchStatusFlag.equals("A")){
		%>	
<%--		<td class="labelname" align="left" colspan="25" style="font-size: 12px;font-weight: bold;padding-left: 10px;" nowrap="nowrap"><font color="blue">--%>
		<%	}else{
		%>	<%=result1.equalsIgnoreCase("") ? "-" :result1%></td>
		<%	}
		%>
		<td class="labelname" colspan="25" align="left" style="padding-left: 10px;"  nowrap width="1%">Scorer1 :&nbsp;<%=scorerOne.equalsIgnoreCase("") ? "-" :scorerOne%> , 
		Scorer2 :&nbsp;&nbsp;<%=scorerTwo.equalsIgnoreCase("") ? "-" :scorerTwo%> </td>	
	</tr>
	<tr bgcolor="#e6f1fc">
		<td class="labelname" align="left" style="padding-left: 10px;" nowrap="nowrap" colspan="25">1.UMPIRE :&nbsp;&nbsp;<%=umpireOne.equalsIgnoreCase("") ? "-" :umpireOne%> ,
		2.UMPIRE :&nbsp;&nbsp;<%=umpireTwo.equalsIgnoreCase("") ? "-" :umpireTwo%>  , 
		3.UMPIRE :&nbsp;&nbsp;<%=umpireThree.equalsIgnoreCase("") ? "-" :umpireThree%></td>
		<td class="labelname" align="left" style="padding-left: 10px;" nowrap="nowrap" width="1%" colspan="25">UMPIRE COACH :&nbsp;&nbsp;<%=umpireFour.equalsIgnoreCase("") ? "-" :umpireFour%> ,
		REFEREE :&nbsp;<%=matchReferee.equalsIgnoreCase("") ? "-" :matchReferee%> </td>		
	</tr>
	<tr bgcolor="#f0f7fd">
		<td class="labelname" align="left" style="padding-left: 10px;"  nowrap="nowrap" colspan="25">CAPTAIN :&nbsp;
		<font color="blue"><%=captainOne.equalsIgnoreCase("") ? "-" :captainOne%> &nbsp;</font>&&nbsp;<font color="blue"><%=captainTwo.equalsIgnoreCase("") ? "-" :captainTwo%></font></td>
		<td class="labelname" align="left" style="padding-left: 10px;"  nowrap="nowrap" colspan="25"> WICKET KEEPERS : &nbsp;
	...
	<tr bgcolor="#e6f1fc"><td colspan="50"><hr></td></tr>
</table>
			...
			<tr>
				...
				<table width="250" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<table width="250" border="0" cellspacing="0" cellpadding="0"
							background="../Image/WagonWheelBG.jpg">
							<tr>
								<td>&nbsp;</td>
								<td width="139" height="237">
								<div id="groundCanvas">
									<img src="../Image/WagonWheel_2.jpg" width="286" height="360" id="wagon" border="0"/> 
									<div id="WagonWheel" style="display:none; position:absolute; top: 174px; left: 12px; border:'1'">
										<img id="responseWagon" name="responseWagon" width="286"
										height="360" border="0" align="left"/>
										</div>
								</div>
								</td>
								<td>&nbsp;</td>
					...
					<tr>
						...
						<table width="250" border="0" cellspacing="0" cellpadding="0"
							background="../Image/PitchBG.jpg">
							<tr>
								<td>&nbsp;</td>
								<td width="139" height="237">
								<div id="pitchCanvas"><img src="../Image/PitchFinal.jpg" width="139"
									height="237" border="0" usemap="#pitch" />
								<div id="pitch_report"
									style="display:none; position:absolute; top: 535px; left: 65px; border:'1'">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="center" background="../Image/BatsmanHeading.jpg"
									...
									<tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0"
											id="BATT_TABLE" name="BATT_TABLE">
											 <tr>
                            					<td class="colheading" width="20px" align="center">No</td>
					                            <td class="colheading" width="45px" align="center">Time</td>
					                            <td class="colheading" width="245px" align="left" style="padding-left: 3px;">Batsman</td>
					                            <td class="colheading" width="50px" align="left" style="padding-left: 3px;">H.Out</td>
					                            <td class="colheading" width="250px" align="left" style="padding-left: 3px;">Bowler</td>
					                            <td class="colheading" width="50px" align="right">Runs</td>
					                            <td class="colheading" width="30px" align="right">Balls</td>
					                            <td class="colheading" width="45px" align="right">Min</td>
					                            <td class="colheading" width="30px" align="right">4</td>
					                            <td class="colheading" width="30px" align="right">6</td>
					                            <td class="colheading" width="70px" align="right">SR</td>
 						                     </tr>		
<%
			int i = 2;
			int rownum = 1;
...
%>
				...
				%>
						...
						|| battingSummaryCachedRowSet.getString("timein")
								.equals(" ")) {
				%>
												<td nowrap="nowrap"><%} else {
					%>
												<td align="center" valign="middle" nowrap="nowrap" class="lefttd"
...
%>
												...
												<td class="lefttd" align="left" nowrap="nowrap"><%=battingSummaryCachedRowSet
						...
						.getString("runs")%></td>
												<td align="right" nowrap="nowrap"><%=battingSummaryCachedRowSet.getString("balls").equals(
								"-1") ? "" : battingSummaryCachedRowSet
						.getString("balls")%></td>
												<td align="right" nowrap="nowrap"><%=battingSummaryCachedRowSet.getString("mins").equals(
								"-1") ? "" : battingSummaryCachedRowSet
						.getString("mins")%></td>
...
%>
							...
							<tr>
								<td align="center" bgcolor="#ABA9AA"><img
									src="../Image/TableBottom.jpg" width="522" height="14"></td>
							</tr>
						</table>
						</td>
					</tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<table width="558" border="0" align="center" cellpadding="0"
									...
									<tr>
										    <td width="34px" class="colheading" align="center">No</td>
						                    <td width="110px" class="colheading" align="center">Bowler</td>
						                    <td width="40" class="colheading" align="right">&nbsp;Over</td>
						                    <td width="25" class="colheading" align="right">Maiden</td>
						                    <td width="40" class="colheading" align="right">Runs</td>
						                    <td width="20" class="colheading" align="right">Wkt</td>
						                    <td width="25" class="colheading" align="right">Wd</td>
						                    <td width="20" class="colheading"  align="right" style="text-align: left">&nbsp;&nbsp;&nbsp;&nbsp;Nb</td>
						                    <td width="45" class="colheading" align="right">SR</td>
						                    <td width="40" class="colheading" align="right">Eco</td>
									</tr>
									<%
			int j = 2;
...
%>
										<td></td>
										<td align="left" class="lefttd"><a style="text-decoration: none;"
					                    ...
					                    <td align="center"><%=bowlerscoreeCachedRowSet.getString("maiden")%></td>
...
%>
		...
		%>
							...
							<tr>
								<td align="center"><img src="../Image/TableBottom.jpg"
