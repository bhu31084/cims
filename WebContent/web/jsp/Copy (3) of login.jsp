...
<% }else{%>
 ...
 <%}%>
 	<form method="post" id="frmScorer" name="frmScorer" onkeypress="catchEnter(event)">
 	  ...
 	  <div id="outerDiv" style="width: 1000px;background-color: #F4FCFF;float: left">
 	    <table>
 	    	<tr>
 	    	   <td valign="top"><%@ include file="commiteeinfo.jsp" %> 	    	   	 
 	    	   </td>
 	    	   <td valign="top"><input type="hidden" name="hidseason" id="hidseason" value="<%=season%>"> </input>
 	    	   	 <div id="SecondColDiv" style="width: 600px;">
		 	     	<table id="" border="1" style="width: 600px;" class="contenttable">
		 	     		<tr>
		 	     		   <td style="height: 252px;width: 600x;padding-left: 1px;" valign="top" colspan=2>
		 	     		   <table style="height: 252px;width: 600px;" border="0" class="contenttable" align="c" >
							   <tr>
							 	<td background = "../Image/top_bluecen.jpg" colspan="2" style="font-size: 16px;color: white;font-weight: bolder;font-family: georgia;padding-left: 7px;" >Association</td>
							   </tr>
							   <tr>
							   <td>
							    <table style="height: 252px;width: 280px;" border="0" class="contenttable" id="AssoNameById" align="c" >
							   <%if(crsObjGetAssociations != null && crsObjGetAssociations.size()>0){
							    ...
							    <td style="text-align: left;font-size: 11px;font-family: Arial; ">									  			
							     <a style="text-decoration: none;color: black;" href="javascript:getAssociationData('<%=crsObjGetAssociations.getString("club_id")%>','<%=clubname%>','<%=season%>','<%=clublogo%>');" id="dpAssociation" name="dpAssociation" ><%=clubname%></a>
							    </td>
		 	     	  ...
		 	     	  <!-- <td width="310" valign="top" align="center" >
		 	     		...
		 	     		<tr>
		 	     			<td style="width: 280px;" valign="top" >   	   	  	   	 
								...
								<tr>
							 	<td background = "../Image/top_bluecen.jpg" colspan="4" style="font-size: 16px;color: white;font-weight: bolder;font-family: georgia;padding-left: 7px;" >Tournament</td>
							   </tr>
							    ...
							    <td style="text-align: center;font-size: 13px;"><b>Matches</b></td>		    
							     ...
							     while(crsObjGetSeries.next()){
								    ...
								    <td style="text-align: left;font-size: 11px;" >									  			
								     <a style="text-decoration: none;color: black" href="javascript:SeriesMatchPointsTally('<%=SeriesType%>','<%=SeriesDescription%>');showTopBowler('<%=SeriesType%>','<%=SeriesDescription%>')" id="dpAssociation<%=SeriesType%>" name="dpAssociation<%=SeriesType%>" class="serieslinks"><%=SeriesDescription%></a>
								    </td>
...
<!--		 	     			      	</tr>-->
 	    	   ...
 	    	   <td valign="top">
	    	   	 	<table  border="1" class="contenttable" style="width: 172px;height: 282px;">					
		...
		%>			<tr>
						...
						<div id="loadScoreDiv" style="width:170px;" class="scrollBarsHV">
							<table border="0" width="170" > 
								<tr> 
									<td width="170" valign="top">						
										<DIV style="width: 170px;" id="leftdiv">
...
<script type="text/javascript">
try {
var pageTracker = _gat.getTracker("UA-10230357-2");
