	...
	xmlHttp=GetXmlHttpObject();
		...
		if(xmlHttp==null){
			...
			return;
				...
				var url;
		    	url="/cims/web/jsp/validatelogin.jsp?username="+username;
	...
	function getseasonfrmheader(){				
		...
		if(xmlHttp==null){
			...
			return;
				...
				var url;
		    	url="/cims/web/jsp/setSeasonInSession.jsp?seasonid="+seasonid;
				xmlHttp.open("post",url,false);
			   	xmlHttp.send(null);
			   	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){
					var responseResult= xmlHttp.responseText;
					...
					//alert("---"+document.getElementById("dpseasonList").value.selected )
					//document.getElementById("hdseason").innerHTML = responseResult;	
					//alert("---"+document.getElementById("hdseason").innerHTML )				
					//window.location.reload();
					//location.reload();
					//window.location.reload();
				}
...
<%--            <td background="../Image/MenuBG.jpg" width="20" height="29" style="color: white;"></td>--%>	
            ...
            <td width="47" height="29" style="background-color: black;">
				...
				<%
				SeasonId = session.getAttribute("season") == null?"5":session.getAttribute("season").toString();
            ...
            <td width="47" height="29"><a href="/cims/web/jsp/login.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Home','','../Image/HomeH.jpg',1)" ><img src="../Image/Home.jpg" alt="Home" name="Home" width="47" height="29" border="0" id="Home" /></a></td>            
            <td width="74" height="29"><a href="/cims/web/jsp/AboutBcci.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('About','','../Image/AboutH.jpg',1)"><img src="../Image/About.jpg" alt="About" name="About" width="74" height="29" border="0" id="About" /></a></td>
            <td width="65" height="29"><a href="/cims/web/jsp/YearlySchedule.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Schedule','','../Image/ScheduleH.jpg',1)"><img src="../Image/Schedule.jpg" alt="Schedule" name="Schedule" width="65" height="29" border="0" id="Schedule" /></a></td>
            <td width="45" height="29"><a href="/cims/web/jsp/playersStatus.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Stats','','../Image/StatsH.jpg',1)"><img src="../Image/Stats.jpg" alt="Stats" name="Stats" width="45" height="29" border="0" id="Stats" /></a></td>
            <td width="56" height="29"><a href="/cims/web/jsp/resultsofwholeyear.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Results','','../Image/ResultsH.jpg',1)"><img src="../Image/Results.jpg" alt="Results" name="Results" width="56" height="29" border="0" id="Results" /></a></td>
            <td width="85" height="29"><a href="/cims/web/jsp/FutureSeriesDetails.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Future Series','','../Image/FutureSeriesH.jpg',0)"><img src="../Image/FutureSeries.jpg" alt="Future Series" name="Future Series" width="85" height="29" border="0" id="Future Series" /></a></td>
            <td width="105" height="29"><a href="/cims/web/jsp/mobile.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Mobile','','../Image/MobileH.jpg',1)"><img src="../Image/Mobilemenu.jpg" alt="Mobile" name="Mobile" width="105" height="29" border="0" id="Mobile" /></a></td>
          </tr>
        </table>
