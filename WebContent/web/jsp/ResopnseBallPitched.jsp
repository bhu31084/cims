...
<%
		try {
			...
			fileStr = "/" + fileStr.substring(1, length) + "/web/Image/PitchFinal.jpg";
			System.out.println("fileStr "+fileStr);
			//fileStr = "../Image/PitchFinal.jpg";
			...
			crsPointsDetail = generateStProc.GenerateStoreProcedure(
					"esp_dsp_ball_pitch_report", vSpParam, "ScoreDB");
