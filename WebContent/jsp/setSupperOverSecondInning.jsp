...
<%
	try{		
		...
		vparam.add(matchId);					
		crsInningId = lobjGenerateProc.GenerateStoreProcedure("esp_dsp_inningdetails_supper_over",vparam,"ScoreDB");																					
		vparam.removeAllElements();	
		if(crsInningId!=null){
	...
	{		
		...
		vparam.add("Y");
		crsAddNextInningData=lobjGenerateProc.GenerateStoreProcedure("esp_amd_supperover_inningstwo",vparam,"ScoreDB");
		vparam.removeAllElements();	
