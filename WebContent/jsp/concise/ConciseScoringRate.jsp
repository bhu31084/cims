...
<%
	...
	if(HidId!=null && HidId.equalsIgnoreCase("1")){
		 try{
		 	 ...
		 	 crsObjAddInning = lobjGenerateProc.GenerateStoreProcedure("esp_amd_scoringrate",vparam,"ScoreDB");
		...
		try{
		 ...
		 vparam.add(Runs);
		 vparam.add("1");
		 crsObjbatsmandetails = lobjGenerateProc.GenerateStoreProcedure("esp_dsp_scoringrate",vparam,"ScoreDB");
	  	 vparam.removeAllElements();
	  	 if(crsObjbatsmandetails!=null){
	  	 	while(crsObjbatsmandetails.next()){
			  	...
			  	Minutes   = crsObjbatsmandetails.getString("minutes")==null?"0": crsObjbatsmandetails.getString("minutes");
		  	 	wickets  = crsObjbatsmandetails.getString("wickets")==null?"": crsObjbatsmandetails.getString("wickets");
	...
	if(HidId!=null && (HidId.equalsIgnoreCase("1") || HidId.equalsIgnoreCase("2") || HidId.equalsIgnoreCase("3"))){
		response.sendRedirect("/cims/jsp/concise/ConciseMatchTab.jsp?tab=7&inning="+cmbinning);
		return;
	}
...
%>  
  	...
  	<body>
    	<div style="height:10em">	
   			<table style="width:70em;" border="0"  cellspacing="1" cellpadding="3">
			  	<tr>
			        <td colspan="8" height="20%" width="100%" background = "../../images/top_bluecen.jpg" valign="middle" class="tabHeading">
			          	<center>Scoring Rate Details Entry Module</center>
			        </td>
		      	</tr>
       			<tr>
      			...
      			<tr bgcolor="#f0f7ff">
			        ...
			        <td align="center" width="15%">Overs</td>
					<td align="center" width="15%">Minutes</td>
					<td align="center" width="15%">Wickets</td>
      			...
      			<tr bgcolor="#e6f1fc" height="5%">
        			<td align="center">
          				<select id="selinning" name="selinning" tabindex="1" onchange="scoreingrate('5');" >
					...
					<td align="center">
			          	<input type="text" name="txtOvers" id="txtOvers" onfocus="clearTextBox('txtOvers')" onblur="fillZero('txtOvers')" value="<%=Overs%>" class="textBox" tabindex="3" onKeyPress="return keyRestrict(event,'1234567890.');">
			        </td>
					<td align="center">
			          	<input type="text" name="txtMinutes" id="txtMinutes" onfocus="clearTextBox('txtMinutes')" onblur="fillZero('txtMinutes')" value="<%=Minutes%>" class="textBox" tabindex="4" onKeyPress="return keyRestrict(event,'1234567890');">
			        </td>
			        <td align="center">
			          	<input type="text" name="txtwickets" id="txtwickets" onfocus="clearTextBox('txtwickets')" onblur="fillZero('txtwickets')" value="<%=wickets%>" class="textBox" tabindex="5" onKeyPress="return keyRestrict(event,'1234567890');">
			        </td>
			        <td align="center">
					...
					<%if(HidId!=null && HidId.equalsIgnoreCase("4")){%>			
						<input type="button" name="btnadd" id="btnadd" value=" SAVE " class="btn" tabindex="7" onclick="scoringrateadd(2);">
					<%}else{%>					
						<input type="button" name="btnadd" id="btnadd" value=" ADD " class="btn" tabindex="8" onclick="scoringrateadd(1);">
					<%}%>
		 			</td>
      			</tr>
    		</table>
	...
	<%try{
	 	...
	 	vparam.add("");
	 	vparam.add("2"); 
	 	crsObjrate = lobjGenerateProc.GenerateStoreProcedure("esp_dsp_scoringrate",vparam,"ScoreDB");
	  	vparam.removeAllElements();
	}catch(Exception e){
	  	log.writeErrLog(page.getClass(),MatchId,e.toString());	
	}%>
		...
		<div id="viewdiv" style="overflow: auto; height:15em;" >
			<table style="width:70em;" border="0"  cellspacing="1" cellpadding = "3">
				...
				<tr bgcolor="#e6f1fc">	
				    ...
				    <td align="center"><a href="/cims/jsp/concise/ConciseMatchTab.jsp?tab=7&inning=<%=crsObjrate.getString("inning")%>&HidId=4&Runs=<%=crsObjrate.getString("runs")%>">Edit</a></td>
					<td align="center" ><a href="/cims/jsp/concise/ConciseScoringRate.jsp?selinning=<%=crsObjrate.getString("inning")%>&HidId=3&Runs=<%=crsObjrate.getString("runs")%>">Delete</a></td>
				</tr>
						<%i++;	 
						}
     				}// end of if
