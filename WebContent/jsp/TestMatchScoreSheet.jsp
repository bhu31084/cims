...
%>
				 ...
				 <input type=button value="print" onClick='window.open("/cims/jsp/TestMatchScoreShit.jsp?isprint=true","CIMS","location=no,directories=no,status=Yes,menubar=Yes,scrollbars=Yes,resizable=Yes,top=0,left=0,width="+(window.screen.availWidth-20)+",height="+(window.screen.availHeight-30))'>
<%
		}
    	...
    	// Getting Data for TeamOne Batting	 
    		...
    		// alert("Team 1" +inningIdTwo);
              ...
              if (xmlHttp==null){
                  ...
                  var url="/cims/jsp/TeamSummery.jsp?inningIdOne="+inningIdOne+"&inningIdTwo="+inningIdTwo+"&firstinningbattingteam="+firstinningbattingteam;
        	...
        	// alert("Team 2" +inningIdTwo);
              ...
              if (xmlHttp==null){
                  ...
                  var url="/cims/jsp/TeamSummery.jsp?inningIdOne="+inningIdOne+"&inningIdTwo="+inningIdTwo+"&secondinningbattingteam="+secondinningbattingteam;
