...
try {	
	...
	if(request.getParameter("hdSubmit")!=null && request.getParameter("hdSubmit").equals("submit")){
		...
		String gsweatherName =	request.getParameter("txtappealname");
		String gsweatherDesc =	request.getParameter("txtappealdesc");
		...
		System.out.println("flag " + flag);
		 ...
		 /*-------------------------- Added By Vishwajeet --------------------------------------------*/
				...
				lvValidatorId.add("appealName");	
				lvFieldName.add("Appeal Type Name");	
				
				lvFormsData.add(gsweatherDesc);
				lvValidatorId.add("appealDesc");	
				lvFieldName.add("Appeal Type Description");
				
				lvFormsData.add(flag);
				lvValidatorId.add("flag");	
				lvFieldName.add("Appeal Status");	
			...
			/***************************************************************************************/
 				if(serverMessage.equals("")) {
						...
						crsObjWeather = lobjGenerateProc.GenerateStoreProcedure(
							"esp_amd_appealsmst",vparam,"ScoreDB");			
						vparam.removeAllElements();	
				}			
	}
	vparam.add("0");
			crsObjweathercombo = lobjGenerateProc.GenerateStoreProcedure(
					"esp_dsp_appealsearch", vparam, "ScoreDB");
					}catch(Exception e){
		e.printStackTrace();
	}
...
%>
<html>
<head><title>Appeal type Master</title>
<link href="../../css/adminForm.css" rel="stylesheet" type="text/css" />
  <script language="JavaScript" src="../../js/jsKeyRestrictvalidation.js" type="text/javascript"></script>
	...
	function callNextPage(id){
    		...
    		document.frmappeal.action = "/cims/jsp/admin/AppealMaster.jsp";    		
	 ...
	 function cancellation(){
			...
			document.frmappeal.action = "/cims/jsp/MasterWeathertype.jsp";			
		}
...
function displayData(){
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){
		   var responseResult = xmlHttp.responseText ;
            ...
            document.getElementById("txtappealdesc").value =mess[2] //xmlDoc.getElementsByTagName("Desc")[0].childNodes[0].nodeValue;  
    ...
    function SelObj(formname,selname,textname,str) {
      ...
      function setUp() {
        obj1 = new SelObj('frmappeal','itemlist','resultsearchtxt');
        obj1.bldInitial(); 
      }
	...
	function update(event) {
    	if(event.keyCode == 13 || event.keyCode == 0 || event.keyCode == 9 || event.button == 0 ){
	        document.frmappeal.resultsearchtxt.value = document.frmappeal.itemlist.options[document.frmappeal.itemlist.selectedIndex].text;
    	    document.getElementById("resultsearchtxt").focus();
    	    hideList();
    	    document.frmappeal.hditemlist.value=document.frmappeal.itemlist.value;
    ...
    function showList(event) {
      ...
      function hideList() {
        ...
        var valName=document.frmappeal.itemlist.value;
           if(valName!=""){
        var url = "/cims/jsp/admin/AppealSearchfromcombo.jsp?Appealid="+valName;
...
<FORM name="frmappeal" id="frmappeal" method="post">
...
%>
<div class="leg">Appeal Type Master</div>
<%--    Venue Master--%>
...
<%-- --------------------------------------------------------------------------------------------%>
	...
	%>
			...
			<tr>
				<td>
					<fieldset><legend class="legend1">Appeal Details
								</legend> 
						<br>
...
<%--		search end--%>
						...
						<tr width="90%" class="contentLight">
							<td nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Appeal Type Name :</td>
						   	<td>
								<input type="text" class="textBoxAdmin" name="txtappealname" id="txtappealname" onfocus = "this.style.background = '#FFFFCC'"  onblur = "changeColour(this)" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz -_/.,%@&?()!1234567890');" value="" >
							</td> 
						</tr>
						<tr align="left" class="contentDark">							
						   	<td nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Appeal Type Description:</td> 
							<td>
								<input type="text" class="textBoxAdmin" name="txtappealdesc" id="txtappealdesc" onfocus = "this.style.background = '#FFFFCC'"  onblur = "changeColour(this)" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz -_/.,%@&?()!1234567890');" value="" >
							</td> 
						</tr>
