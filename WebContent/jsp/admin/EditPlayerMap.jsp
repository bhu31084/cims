...
<FORM action="" name="frmEditPlayer" id="frmEditPlayer" method="post">
<br>
<br>
<br>
			...
			<table width="90%" border="0" align="center" cellpadding="2"
				...
				<tr class="contentDark">	
				    ...
				    <TD colspan="3" width="30%" nowrap align="left" valign="top" >
				        ...
				        onclick="showCal('FrCalendarFrom','DateFrom','txtDateFrom','frmEditPlayer')">
				            <a href="javascript:showCal('FrCalendarFrom','DateFrom','txtDateFrom','frmEditPlayer')">
				    ...
				    <TD  width="30%" nowrap align="left">	
				        ...
				        onclick="showCal('FrCalendarTo','DateTo','txtDateTo','frmEditPlayer')">
				        <a href="javascript:showCal('FrCalendarTo','DateTo','txtDateTo','frmEditPlayer')">
				        <IMG src="../../images/cal.gif" border="0" alt=""></a>&nbsp;&nbsp;&nbsp;&nbsp;
				    </TD>
