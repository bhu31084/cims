...
<head>
    ...
    <script language="javascript">
    	function printLetters(flag){
				...
				var scorer1id = document.getElementById('hdscorer1Id').value;
				var scorer1nm = document.getElementById('hdscorer1').value;
				var scorer2id = document.getElementById('hdscorer2Id').value;
				var scorer2nm = document.getElementById('hdscorer2').value;
				...
				if((flag == "s1")&&(document.getElementById('scorer1').innerHTML != "")){
	    			winhandle = window.open("/cims/jsp/admin/ScorerAnalysisAppointMentLetter.jsp?flag="+ flag +
	    	    			"&matchpre_date="+matchpre_date+"&seriesname="+seriesname+"&matchtypeflag="+matchtypeflag+
	    	    			"&clubname="+clubname+"&matchId="+matchId+"&scorer1id="+scorer1id+
	    	    			"&scorer1nm="+scorer1nm+
	    	    			"&email="+email+
	    		...
	    		}else if((flag == "s2")&&(document.getElementById('scorer2').innerHTML != "")){
	    			winhandle = window.open("/cims/jsp/admin/ScorerAnalysisAppointMentLetter.jsp?flag="+ flag +"&matchpre_date="+matchpre_date+
	    	    			"&seriesname="+seriesname+"&matchtypeflag="+matchtypeflag+"&clubname="+clubname+
	    	    			"&matchId="+matchId+"&scorer2id="+scorer2id+"&scorer2nm="+scorer2nm+"&matchdate="+matchdate+
	    	    			"&matchenddate="+matchenddate+"&team1="+team1+"&team2="+team2+
	    	    			"&venue="+venue+"&team1nickname="+team1nickname+
	    	    			"&email="+email+
	    	    			"&team2nickname="+team2nickname,"battingreport","location=no,directories=no,status=no,menubar=no,scrollbars=Yes,resizable=yes,top=0,left=0,width="+(window.screen.availWidth-40)+",height="+(window.screen.availHeight-20));
	    		}else if((flag == "a1")&&(document.getElementById('analysis').innerHTML != "")){
	    			winhandle = window.open("/cims/jsp/admin/ScorerAnalysisAppointMentLetter.jsp?flag="+ flag +"&matchpre_date="+matchpre_date+
	    	    			"&seriesname="+seriesname+"&matchtypeflag="+matchtypeflag+"&clubname="+clubname+
    	...
    	function sendSmstoall(scorer1Id,scorer2Id,analysis,analysis1,matchId,team1,team2,matchdate,venue,seriesname){
    		window.open("../sms/SMSScorerPushAll.jsp?scorer1Id="+scorer1Id+"&scorer2Id="+scorer2Id+"&seriesname="+seriesname+"&matchId="+matchId+"&matchdate="+matchdate+"&team1="+team1+"&team2="+team2+"&venue="+venue,"sendsms","location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,top=250,left=450,width="+(window.screen.availWidth-600)+",height="+(window.screen.availHeight-500));
        }
...
<tr class="contentLight"><!--From System-->
	<td >Scorer 1 : </td>
 	<%if(scorer1 != null){%>
 	<td id="scorer1"><%=scorer1%></td>
 	<%}else{%>
 	<td id="scorer1"></td>
 	<%}%>
 	<td ><input class="contentDark" type="button" align="center" value="Print Preview" onclick="javascript:printLetters('s1')">
 	<input type="hidden" id="hdscorer1" name="hdscorer1" value="<%=scorer1%>" >
 	<input type="hidden" id="hdscorer1Id" name="hdscorer1Id" value="<%=scorer1_id%>" ></td>		

</tr>
<tr class="contentDark"><!--From System-->
	<td >Scorer 2 : </td>
 	<%if(scorer2 != null){%>
 	<td id="scorer2"><%=scorer2%></td>
 	<%}else{%>
 	<td id="scorer2"></td>
 	<%}%>
 	<td ><input class="contentDark" type="button" align="center" value="Print Preview" onclick="javascript:printLetters('s2')">
 	<input type="hidden" id="hdscorer2" name="hdscorer2" value="<%=scorer2%>" >
 	<input type="hidden" id="hdscorer2Id" name="hdscorer2Id" value="<%=scorer2_id%>" ></td>		
