<!--
	Page Name 	 : RefereeAppointMentLetter.jsp
	Created By 	 : Archana Dongre.
	Created Date : 4th Nov 2008
	Description  : Match Referee's Appointment Letter
...
try { 
			...
			CachedRowSet crsObjteam1Abbreviation = null;
			CachedRowSet crsObjteam2Abbreviation = null;
		    ...
		    emailMsg ="<table width='700' border='0' align='center' cellpadding='2' cellspacing='1' class='table'>"+
			 ...
			 "<td colspan='1'></td></tr>" +
			 "<tr class='refereeContentDark'>"
			 + "<td colspan='1'>To Accept please click Accept link <b><a href='"+applicationUrl+"/OfficialStatus?match="+ matchId +"&offical="+referee_id+"&status=Y'>Accept</a></b>"
			 + "<td colspan='3'>To Reject please click Reject link <b><a href='"+applicationUrl+"/OfficialStatus?match="+ matchId +"&offical="+referee_id+"&status=N'>Reject</a></b>"
			 + "</tr>" +
			 "<tr class='refereeContentDark'>"+
			 "<td ></td><td colspan='4'>"+
			 "</tr></table>"+
...
<html>
<head>
    <title> Match Referee AppointMent Letter </title>
...
<%--    <link rel="stylesheet" type="text/css" href="../../CSS/Styles.css">--%>
    ...
    function PrintPage(flag){    	
    	if(flag == "1"){    		
    		...
    		if (xmlHttp==null){
				...
				var url ;					             
                url="IncreaseOfficialsCountResponse.jsp?usertype="+usertype;	               
	...
	function mail(){    		
		var refereeid = document.getElementById("referee_id").value;
	    document.getElementById("frmrefereeAptLetter").action="RefereeAppointMentLetter.jsp?mailflag=1&referee_id="+refereeid;
	    document.getElementById("frmrefereeAptLetter").submit();
	}
...
<FORM name="frmrefereeAptLetter" id="frmrefereeAptLetter" method="post"><br>
	...
	<table>
		<tr>
			<td align="center" colspan="2">
				...
				<input type="hidden" name="referee_id" id="referee_id" value="<%=referee_id%>">			
				...
				<input type="hidden" name="team2nck" id="team2nck" value="<%=team1nck%>">
				...
				<input type="hidden" name="refereeAssociation" id="refereeAssociation" value="<%=Association%>">			
			</td>
		</tr>
	</table>
	<%
	if(mailflag!=null && mailflag.equalsIgnoreCase("1")){
        ...
        vparam.add(matchId);//display teams
        vparam.add(referee_id);//display teams
