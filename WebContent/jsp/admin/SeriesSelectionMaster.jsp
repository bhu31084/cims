		...
		function callNextPage(){
			...
			document.getElementById('txttotalmatchNo').value == "" || document.getElementById('txtDescription').value == "" )
			{
				alert("Please enter data in all fields");
					...
					document.frmSeriesMaster.action ="/cims/jsp/admin/SeriesSelectionMaster.jsp?TournamentId="+TournamentId+"&MatchTypeId="+MatchTypeId+"&MatchCategoryId="+MatchCategoryId+"&description="+description+"&season="+season+"&maxMateches="+maxMateches+"&SeasonId="+SeasonId;
					document.frmSeriesMaster.submit();
				}
		}
		function cancellation(){
			document.frmSeriesMaster.action = "/cims/jsp/admin/SeriesSelectionMaster.jsp";
			document.frmSeriesMaster.submit();
		}
		function ChangePage(){
			var flag = "1";
			var r = confirm("Do you Want to Register New Series ?");
            	if (r == true)
            	{
            		window.open("/cims/jsp/admin/SeriesTypeMaster.jsp?flag="+flag,"CIMS","location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes,top=20,left=20,width=500,height=400");
                }else
                	{
                		document.frmSeriesMaster.action = "/cims/jsp/admin/SeriesSelectionMaster.jsp";
                    }
...
<jsp:include page="Menu.jsp"></jsp:include> 
	...
	<div class="leg">Tournament Master</div>
...
%>
							    ...
							    <input type="button" class="btn btn-small" id="btnmatchtype" name="btnmatchtype" value="..."  size="2" onclick="ChangePage()" >
							</td>							 
						   	<td>Season :</td>						   	
						   	<td>
...
%>
						...
						<tr width="100%" align="right" class="contentLight">				
				       		...
				       		<td  align="right" colspan="4">
				       			<input type="button" class="btn btn-warning" id="btnsubmit" name="btnsubmit" value=" Submit" onclick="callNextPage()">
				      			<input type="button" class="btn btn-warning" id="btnCancel" name="btnCancel" value="Cancel" onclick="cancellation()" >	 
