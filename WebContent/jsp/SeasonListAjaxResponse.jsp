...
%>
		<SELECT name="season_id" id="season_id" onkeyup="updateSeason(event)" onclick="updateSeason(event)" onkeypress="updateSeason(event)" class="inputsearch" style="width:2.0cm" size="5">
<%
