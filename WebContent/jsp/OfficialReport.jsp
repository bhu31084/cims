...
<head>
    ...
    <script language="javascript">
	 ...
	 /************** For Bowler Statistics List **********************************************************************/
      ...
      /*function callWickets(matchid){
      alert("in callWickets"+matchid)
      document.getElementById("hdMatchId").value = matchid
      alert(document.getElementById("hdMatchId").value)
     window.open("TeamScoreDetails.jsp","scorecard","location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,top=250,left=250,width="+(window.screen.availWidth-400)+",height="+(window.screen.availHeight-400));
      }*/
...
<table width="1000" border="0" align="center" cellpadding="2"	cellspacing="1" class="table">
	<tr>
	   <td width="100%" colspan="3" align="left" class="legend">Officail Report</td>
	</tr>	
</table>
<table width="1000" border="0" align="center" cellpadding="2"	cellspacing="1" class="table">
	<tr>
	...
	<input class="button1"	id="show" type="button" value="V" onClick="changeList(event);" <%=seriesId.equalsIgnoreCase("0")?"":"disabled"%>>
	<DIV align="left" style="width:250px">
...
%>	
 ...
 <TD>
	...
	OR <a href="javascript:getPlayerListWindow();">Search</a>
	<%} %>
	 </TD>
  </TR>
