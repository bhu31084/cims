...
<%  
	...
	String analysis = request.getParameter("analysis")==null?"":request.getParameter("analysis");
	String analysis1 = request.getParameter("analysis1")==null?"":request.getParameter("analysis1");
	...
	String userIdRole = analysis+":"+analysis1;
	...
	for(int i = 1,j= 0;i < (userIdRoleArr.length) ;i=i+2,j++){
		...
		if(userIdRoleArr[i].equalsIgnoreCase("a1")){
			userrole = "Main Analysis";
		}else if(userIdRoleArr[i].equalsIgnoreCase("a2")){
			userrole = "Assistant Analysis";
		}
