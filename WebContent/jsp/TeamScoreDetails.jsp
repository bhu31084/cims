...
function Inning(id){
	...
	if (xmlHttp==null){
	  ...
	  var flg = "P";        
	   var url = "/cims/jsp/InningScorecard.jsp?InningIdPre="+InningId+"&flg="+flg;
...
function callRefresh(){
	document.main.action="/cims/jsp/TeamScoreDetails.jsp"
		...
		<tr valign="top" align="left" style="width: 100%">
			<td>
				<table align="center" class="tabber">
					<tr align="center">
						<td>
							<input class="btn btn-warning" type="button" value="Refresh" onclick="callRefresh()"/>
						</td>
					</tr>
					<tr>
						<td>
