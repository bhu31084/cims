...
<%
	...
	hidback = request.getParameter("backFlag")!=null?request.getParameter("backFlag"):"0";
 ...
 <head>
			...
			<script>	 
					...
					function validateDispName(){
						if (document.getElementById('txtdisName').value ==""){
							alert("Enter Display Name");
							document.frmUser.txtdisName.focus();
							return false;
						}else if (document.getElementById('txtdisName').value !=""){
					...
					function addDisplayName(){
						...
						document.getElementById('txtdisName').style.background = '#FFFFCC';
						if (firstName!="" && firstName!=null){
							firstChar = firstName.substring(0,1);
							//document.getElementById('txtdisName').value = firstName+""+firstChar;			
						}if (middleName!="" && middleName!=null){
							middleChar = middleName.substring(0,1);
						}
						if (dispName == "")	{
							document.getElementById('txtdisName').value	  = firstChar+" "+middleChar+" "+lastName;	
						}else{
						}
					}
				...
				function passUserData(userId){
						...
						document.frmUser.action="/cims/jsp/AddNewPlayer.jsp?hidUpdate="+hidUpdate+"&hidUserId="+hidUserId;
						document.frmUser.submit();
 				}
 				...
 				function deleteUser(userId){
 						...
 						var retVal=confirm("Do You Want To Continue");
 						if (retVal==true){
	 						document.frmUser.action="/cims/jsp/UserMaster.jsp?hidDelete="+hidDelete+"&hidUserId="+hidUserId;
	 						document.frmUser.submit();
	 						//userSearch();
						}else{
							return false;
...
<form name="frmUser" id="frmUser" method=post>
			...
			<input type=hidden name=backFlag id=backFlag value="<%=hidback%>" />
			<br>
			
			<table width="95%" align="center" style="border-top: 1cm;">
					<tr>
						<td colspan="10" align="center" style="background-color: #dde2f2"><font size="4" color="#003399"><b>User Detail Form</b></font></td>
					</tr>
					<tr>
						<td></td>
					</tr>
					...
					<tr>
					    <td>
							...
							<table cellspacing=5> 
								...
								<tr>
									<td>&nbsp;</td>
									<td><input class="input" type="text" name="searchNickName" id="searchNickName" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>
									<td>&nbsp;</td>
									<td><input class="input" type="text" name="searchFirstName" id="searchFirstName" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>
									<td>&nbsp;</td>
									<td><input class="input" type="text" name="searchMiddleName" id="searchMiddleName" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>
									<td>&nbsp;</td>
									<td><input class="input" type="text" name="searchLastName" id="searchLastName" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>
									<td>&nbsp;</td>
									<%--<td><input type="button" name="Search"  value="Search" onclick="validateSearch()"></td>
									--%>
									<td><input type="button" class="button" name="Search"  value="Search" onclick="userSearch()"></td>
...
<%	try{	
		...
		if(crsObjRolesCrs != null){	
			while(crsObjRolesCrs.next()){	
				if(crsObjRolesCrs.getString("name").equalsIgnoreCase("player")){					
%>									<option value="<%=crsObjRolesCrs.getString("id")%>" selected="selected"><%=crsObjRolesCrs.getString("name")%></option>
<%				}	
			}
		 }
	   }catch(Exception e){
...
%>									  </select>			   
								...
								<td>
									 <select class="input" name="selClub" id="selClub" >
							 		<option value="0">--select--</option>
...
%>	
								...
								<tr>
									...
									<td><label><font color="#003399"><b>Middle name</b></font></label></td>
									<td><label><font color="#003399"><b>Last name </b></font></label></td>
									<td><label><font color="#003399"><b>Display name</b></font></label></td>
									<%--<td><label><font color="#003399"><b>Password*</b></font></label></td>
...
%>			
									<td><input class="input" type="text" name="txtFUserName" id="txtFUserName" onfocus = "this.style.background = '#FFFFCC'" onblur = "setName();changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>	
<%
	}
%>		
<%	if (hid!=null && hid.equalsIgnoreCase("2")){									
...
%>	
									<td><input class="input" type="text" name="txtMUserName" id="txtMUserName" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>		
<%
	}
%>	
<%	if (hid!=null && hid.equalsIgnoreCase("2")){									
%>					
									<td><input class="input" type="text" name="txtLUserName" id="txtLUserName" onfocus = "this.style.background = '#FFFFCC'" onblur = "addNickname();addDisplayName();changeColour(this)" value="<%=sName%>" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>
<%
	}else{
%>			
									<td><input class="input" type="text" name="txtLUserName" id="txtLUserName" onfocus = "this.style.background = '#FFFFCC'" onblur = "addNickname();addDisplayName();changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>					
<%
	}
%>	
<%	if (hid!=null && hid.equalsIgnoreCase("2")){									
%>
			  						<td>
				 					   <input class="input" type="text" name="txtdisName" id="txtdisName" onfocus = "addDisplayName();this.style.background = '#FFFFCC'" onblur = "validateDispName();changeColour(this)" value="<%=disName%>" onKeyPress="return keyRestrict(event,' abcdefghijklmnopqrstuvwxyz')">
									</td>
<%
	}else{
%>	
									<td>
				 					   <input class="input" type="text" name="txtdisName" id="txtdisName" onfocus = "addDisplayName();this.style.background = '#FFFFCC'" onblur = "validateDispName();changeColour(this)" value="" onKeyPress="return keyRestrict(event,' abcdefghijklmnopqrstuvwxyz')">
									</td>							
<%
	}
%>
...
%>
			  						<td>
				 					   <input class="input" type="password" name="password" id="password" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="<%=password%>">
									</td>
<%
	}else{
%>	
									<td>
				 					   <input class="input" type="password" name="password" id="password" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="">
									</td>							
<%
	}
%>								
...
<%	if (hid!=null && hid.equalsIgnoreCase("2")){									
%>									
									<td><input class="input" type="text" name="txtNickName" id="txtNickName" onfocus = "addNickname(); this.style.background = '#FFFFCC'"  onblur = "validateNickName();changeColour(this)" value="<%=nickName%>" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>
<%
	}else{
%>
									<td><input class="input" type="text" name="txtNickName" id="txtNickName" onfocus = "addNickname(); this.style.background = '#FFFFCC'"  onblur = "validateNickName();changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>
<%
	}
%>	
<%	if (hid!=null && hid.equalsIgnoreCase("2")){									
...
%>	
									<td>
									    <input class="input" type="text" name="txtDob" id="txtDob" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="" readonly>
									    <a href="javascript:showCal('DOBCalendar', 'Birth Date', 'txtDob', 'frmUser')"> 
									    <IMG src="../../images/cal.gif" width="15" border="0" alt=""></a>&nbsp;&nbsp;&nbsp;&nbsp;
									</td>
<%
...
<%	if (hid!=null && hid.equalsIgnoreCase("2")){									
%>					
								    <td><input class="input" type="text" name="txtPob" id="txtPob" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="<%=pob%>" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>
<%
	}else{
%>	
									<td><input class="input" type="text" name="txtPob" id="txtPob" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="" onKeyPress="return keyRestrict(event,'abcdefghijklmnopqrstuvwxyz')"></td>				
<%
	}
%>		
<%	if (hid!=null && hid.equalsIgnoreCase("2")){									
...
<%}else{
%>									<td>
				 					   <input class="input" type="password" name="password" id="password" onfocus = "this.style.background = '#FFFFCC'" onblur = "changeColour(this)" value="pass">
									</td>							
<%}
%>								</tr>
								<tr>
...
%>									<td>
									 ...
									 <td>
									 	<select class="input" name="selGender" id="selGender">
...
<%	if (hid!=null && hid.equalsIgnoreCase("2")){									
%>					
					<td colspan=4 align=center><input type=button  class="button" name="save" id="save" value=Update onclick="validateData()">&nbsp;&nbsp;&nbsp;<input type=button  class="button" name=save value=Delete onclick="deleteUser(<%=hidUserId%>)"></td>
					<td colspan=4 align=center></td>
<%
	}else if(hid!=null && hid.equalsIgnoreCase("3")){
%><%--	
					<td colspan=4 align=center><input type=button  class="button"  class="button"  class="button" name=save value=UPDATE onclick="validateData()">&nbsp;&nbsp;&nbsp;<input type=button  class="button"  class="button" name=save value=DELETE onclick="deleteUser(<%=hidUserId%>)"></td>
					<td colspan=4 align=center></td>
--%>
					<td colspan=4 align=center><input type=button  class="button"  class="button" name="save" id="save" value=Save onclick="validateData()" disabled="disabled"></td>				
<%
	}else{
%>	
					<td colspan=4 align=center><input type=button  class="button"  class="button"  class="button" name="save" id="save" value=Save onclick="validateData()" disabled="disabled"></td>				
<%
	}
%>
				</tr>
				 ...
				 function doGetUserData(){
			          ...
			          if (xmlHttp==null){
			              ...
			              return;
						    ...
						    var url= "/cims/jsp/Searchplayer.jsp?nickName="+nickName +  "&firstName="+firstName + "&middleName="+middleName + "&lastName="+lastName + "&param="+param;
				 ...
				 function validateName(){
			          ...
			          if (xmlHttp==null){
						 ...
						 //		alert("displayname and nick name are same");
							    param = 3;
							    var url= "/cims/jsp/Searchplayer.jsp?nickName="+nickName +  "&displayName="+displayName + "&param="+param + "&userId="+userId;
							 }else if (hidDis == displayName && hidNick != nickName && hidFlag == "1" && hidUpdate != ""){ 
							// 	alert("displayname same and nick is not same");
							    param = 6;
							    var val="";
							    var url= "/cims/jsp/Searchplayer.jsp?nickName="+nickName +  "&displayName="+val + "&param="+param + "&userId="+userId;
							 }else if (hidNick == nickName && hidDis != displayName && hidFlag == "1" && hidUpdate != ""){ 
							 //	alert("nick same and disp not same");
							    param = 5;
							    var val="";
							   // alert("5");
							    var url= "/cims/jsp/Searchplayer.jsp?nickName="+val  +  "&displayName="+displayName + "&param="+param + "&userId="+userId;
							   // alert("return");
							 }else{
							 	//alert("name are not same");
								 var url= "/cims/jsp/Searchplayer.jsp?nickName="+nickName +  "&displayName="+displayName + "&param="+param + "&userId="+userId;
							 }
