...
<%  vparam.add(inningIdTwo);
	firstBatsInningSecondCrs = lobjGenerateProc.GenerateStoreProcedure("esp_dsp_battingsummarylist",vparam,"ScoreDB");
...
<%	
	...
	firstBatsInningFirstCrs = lobjGenerateProc.GenerateStoreProcedure("esp_dsp_battingsummarylist",vparam,"ScoreDB");
	vparam.removeAllElements();
	no = 1;
	try{
		if(firstBatsInningFirstCrs!=null && firstBatsInningFirstCrs.size() > 0){
			while (firstBatsInningFirstCrs.next()){
				 ...
				 mins 		= firstBatsInningFirstCrs.getString("mins")!=null?firstBatsInningFirstCrs.getString("mins"):"";      
				 four		= firstBatsInningFirstCrs.getString("fours")!=null?firstBatsInningFirstCrs.getString("fours"):"";   
				 six		= firstBatsInningFirstCrs.getString("six")!=null?firstBatsInningFirstCrs.getString("six"):""; 
				 balls 		= firstBatsInningFirstCrs.getString("balls")!=null?firstBatsInningFirstCrs.getString("balls"):"";      
				 runs 		= firstBatsInningFirstCrs.getString("runs")!=null?firstBatsInningFirstCrs.getString("runs"):"0";   
