...
//	System.out.println("param ___________________________________________________________-" +param);
%>
...
%>
	<form name="frmUser" id="frmUser" method=post>
			...
			<table width="0.1%" align="left" style="border-top: 1cm;">
					<tr>
						<td colspan="10" align="center" style="background-color:gainsboro;"><font size="4" color="#400040"><b><a href="/cims/jsp/AddNewPlayer.jsp?backFlag=1"> BACK</a></b></font></td>
					</tr>
					<tr>
						<td></td>
					</tr>
			...
			<table width="95%" align="center" style="border-top: 1cm;">
					<tr>
						<td colspan="10" align="center" style="background-color: #dde2f2"><font size="4" color="#400040"><b>User Detail Form</b></font></td>
					</tr>
					<tr>
						<td></td>
					</tr>
