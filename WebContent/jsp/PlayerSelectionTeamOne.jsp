...
<body>
	...
	<tr>
		<td colspan="3" class="legend" align="center">Select Players for Team <%=team1name%></td>
	</tr>
	<tr>
		<td colspan="3"><hr></td>
	</tr>
...
%>			</select>	
		...
		<td align="center">
			...
			<br>		
		 	<input class="btn btn-small" type="button" name="del" id="del" value="<<" size="5"
	...
	<table width="100%" border="0">
	<tr>
		<td colspan="3" class="legend" align="center">Select Extra Players from Team : <%=team1name%></td>
	</tr>
<tr>
	...
	<tr>	
		<td align="center" colspan="3">
			<input type="button" class="btn btn-warning" name="btnNext" id="btnNext" value="NEXT" onclick="callMain();" disabled="disabled">								
		</td>																	
		<td align="center" >&nbsp;</td>
