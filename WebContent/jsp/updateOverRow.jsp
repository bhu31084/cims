...
<%	
	...
	String overno = request.getParameter("over").trim();
	String wicketType = "";
	String fielder1 = "";
	String fielder2 = "";
	String batsman1 = "";
...
<body>
	<table align="center" border="1" width="95%">
		...
		<tr  align="center"class="contentLastDark">
			<td>
...
%>	
			...
			<td>
				<select id="selBatsman" name="selBatsman">
<%				if(batsmenNameCrs != null){	
					
%>					
<%--<option value ="0" <%=fielder2.equalsIgnoreCase("0") ? "selected" : ""%>>-- select --</option>--%>
...
%>	
	...
	<br>
	<input type="button" align="center" value="Update"  onclick="updateWicket(<%=ballId%>),updateScore('<%=(ioverno - 1)%>'),closePopup('BackgroundOverDiv','updateWicketDiv'),closePopup('BackgroundOverDiv','updateRunsDiv')">
	<input type="button" align="center" value="Exit"  onclick="closePopup('BackgroundOverDiv','updateWicketDiv')">
	</body>	
</html>
<%
}//end else
